...
const TutorialToast: FC<Props> = ({onCancel, onTutorial}) => {
  return (
    <>
      <div
      ...
      >
        ...
        >
          ...
          <div className='toast-body d-flex justify-content-end bg-light-info rounded-bottom'>
            <button type='button' onClick={onCancel} className='btn btn-danger me-2'>
              No, Thanks.
            </button>
            <button type='button' onClick={onTutorial} className='btn btn-primary'>
              Yes, I want.
            </button>
          </div>
        </div>
